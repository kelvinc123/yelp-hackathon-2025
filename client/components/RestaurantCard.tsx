...
import { Heart, Star, Image as ImageIcon, DollarSign, MapPin, Clock } from "lucide-react";
        ...
        <div className="relative w-full max-w-[340px] select-none">
            ...
            >
                ...
                <div className="relative h-[190px] bg-gray-200 flex items-center justify-center">
                    ...
                    >
                        <Heart className={`h-5 w-5 ${saved ? "text-rose-500 fill-rose-500" : "text-black"}`} fill={saved ? "currentColor" : "none"} />
                    </button>
